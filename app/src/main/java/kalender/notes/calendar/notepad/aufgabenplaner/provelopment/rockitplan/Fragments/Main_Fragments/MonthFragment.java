...
public class MonthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        circleBigIds = new int[]{R.drawable.circle_month_one, R.drawable.circle_month_two, R.drawable.circle_month_three, R.drawable.circle_month_four, R.drawable.circle_month_five, R.drawable.circle_month_six};
