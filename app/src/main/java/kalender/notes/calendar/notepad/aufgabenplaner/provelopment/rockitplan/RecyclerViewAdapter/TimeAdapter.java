 ...
 */
public class TimeAdapter extends ContentTimeCalendarAdapter {
    ...
    public TimeAdapter(Context context, int timeType, MainActivity mainActivity, ActionModeInterface actionModeInterface) {
